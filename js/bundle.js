                ...
                t.exports = function () {
                    ...
                    function L(e, n, r) {
                        n.constructor === e.constructor && r === w && n.constructor.resolve === b ? function (t, e) {
                            1 === e._state ? C(t, e._result) : 2 === e._state ? T(t, e._result) : M(e, void 0, (function (e) {
                                return A(t, e)
                            }), (function (e) {
                                return T(t, e)
                            }))
                    ...
                    function C(t, e) {
                        t._state === x && (t._result = e, t._state = 1, 0 !== t._subscribers.length && s(j, t))
                    }

                    function T(t, e) {
                        t._state === x && (t._state = 2, t._result = e, s(q, t))
                    }

                    function M(t, e, n, r) {
                        var o = t._subscribers,
                            i = o.length;
                        t._onerror = null, o[i] = e, o[i + 1] = n, o[i + 2] = r, 0 === i && t._state && s(j, t)
                    }
                    ...
                    function k(e, n, r, o) {
                        ...
                        n._state !== x || (i && a ? A(n, s) : !1 === a ? T(n, c) : 1 === e ? C(n, s) : 2 === e && T(n, s))
                    }
                    var $ = 0;

                    function I(t) {
                        t[S] = $++, t._state = void 0, t._result = void 0, t._subscribers = []
                    }
                    var O = function () {
                        function t(t, n) {
                        ...
                        return t.prototype._enumerate = function (t) {
                            ...
                            if (r === b) {
                                ...
                                if (o === w && t._state !== x) this._settledAt(t._state, e, t._result);
                                else if ("function" != typeof o) this._remaining--, this._result[e] = t;
                                else if (n === H) {
                                    var c = new n(E);
                                    s ? T(c, i) : L(c, t, o), this._willSettleAt(c, e)
                            ...
                            var r = this.promise;
                            r._state === x && (this._remaining--, 2 === t ? T(r, n) : this._result[e] = n), 0 === this._remaining && C(r, this._result)
                    ...
                    var H = function () {
                        function e(t) {
                            this[S] = $++, this._result = this._state = void 0, this._subscribers = [], E !== t && ("function" != typeof t && function () {
                    ...
                    }, H.resolve = b, H.reject = function (t) {
                        var e = new this(E);
                        return T(e, t), e
    ...
    n.g = function () {
        ...
        function () {
            ...
            n(702).polyfill(), window.addEventListener("DOMContentLoaded", (() => {
                const n = setTimeout((() => e(".modal", n)), 3e5);
                (function (t, e, n, r) {
                    ...
                    c(), a(), s.addEventListener("click", (function (e) {
                        const n = e.target;
                ...
                function (n, r, o) {
                    ...
                    i.forEach((t => {
                        t.addEventListener("click", (() => e(r, o)))
                    })), s.addEventListener("click", (e => {
                        e.target !== s && "" != e.target.getAttribute("data-close") || t(r)
                    })), document.addEventListener("keydown", (e => {
                        "Escape" === e.code && s.classList.contains("show") && t(r)
                    })), window.addEventListener("scroll", (function t() {
                        window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight && (e(r, o), window.removeEventListener("scroll", t))
                    }))
                }("[data-modal]", ".modal", n),
                function (t, e) {
                    function n(t) {
                    ...
                    document.querySelectorAll(n).forEach((t => {
                        ...
                        (e = t).addEventListener("submit", (t => {
                            ...
                            (async (t, e) => {
                                ...
                                console.log(t), o("Спасибо! Скоро мы с вами свяжемся"), n.remove()
                            })).catch((() => {
                                o("Что-то пошло не так...")
                            })).finally((() => {
                                e.reset()
                            }))
                        }))
                ...
                function ({
                    ...
                    let g = 1,
                        y = 0;
                    a.length < 10 ? (h.textContent = `0${a.length}`, f.textContent = `0${g}`) : (h.textContent = a.length, f.textContent = g), v.style.width = 100 * a.length + "%", v.style.display = "flex", v.style.transition = "0.5s all", m.style.overflow = "hidden", a.forEach((t => {
                        t.style.width = p
                    ...
                    d.addEventListener("click", (() => {
                        y == b(p) * (a.length - 1) ? y = 0 : y += b(p), v.style.transform = `translateX(-${y}px)`, g == a.length ? g = 1 : g++, a.length < 10 ? f.textContent = `0${g}` : f.textContent = g, w.forEach((t => t.style.opacity = ".5")), w[g - 1].style.opacity = 1
                    })), u.addEventListener("click", (() => {
                        0 == y ? y = b(p) * (a.length - 1) : y -= b(p), v.style.transform = `translateX(-${y}px)`, 1 == g ? g = a.length : g--, a.length < 10 ? f.textContent = `0${g}` : f.textContent = g, w.forEach((t => t.style.opacity = ".5")), w[g - 1].style.opacity = 1
                    })), w.forEach((t => {
                        t.addEventListener("click", (t => {
                            const e = t.target.getAttribute("data-slide-to");
                            g = e, y = +b(p) * (e - 1), v.style.transform = `translateX(-${y}px)`, a.length < 10 ? f.textContent = `0${g}` : f.textContent = g, w.forEach((t => t.style.opacity = ".5")), w[g - 1].style.opacity = 1
                        }))
                    }))
                }({
